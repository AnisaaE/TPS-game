...
public class EndGameTrigger : MonoBehaviour
{
    ...
    [Header("UI")]
    public GameObject endDanceCanvas;  // Canvas с надпис "THE END 🕺💃"

    [Header("Settings")]
    public float danceDelay = 3f; // колко секунди трае анимацията на танца
    ...
    private IEnumerator EndSequence()
    {
        ...
        // Стартиране на анимация за танц
        playerAnimator.SetTrigger("Dance");
        rumyAnimator.SetTrigger("Dance");

        // Изчакване докато анимацията на танца завърши
        yield return new WaitForSeconds(danceDelay);

        // Показване на финалния Canvas
        if (endDanceCanvas != null)
            endDanceCanvas.SetActive(true);
    }
}